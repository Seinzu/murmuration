...
audioFolder.add(audioEngine, 'maxBoidDrones', 1, 100, 1).name('Max Drone Voices');
audioFolder.add(audioEngine, 'dedupeBoidPitches').name('Dedupe Pitches');
audioFolder.add(audioEngine, 'voiceGainCompensation').name('Voice Gain Comp');
